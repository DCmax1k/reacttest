  ...
  return (
    <div>
      ...
      <div className='paragraphs'>
        ...
        <Paragraph message="The second most recent addition to this marvelous website is to see a randomly generated number to represent your IQ in a fun way. Knowing your randomly generated IQ over your real IQ could be a lot more fun, and intresting to see what you get. Real IQ's usually stay the same, and are boring. Have Fun!" />
      </div>
      <Footer />
    </div>
  );
